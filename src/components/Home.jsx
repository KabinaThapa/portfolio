...
const Home = () => {
  return (
    ...
    <div className=" flex flex-col justify-center   space-y-6  p-2 md:bg-black md:bg-opacity-50 md:bg-transparent md:w-[28%] md:h-auto h-screen  w-full md:absolute md:top-[16rem] md:left-[24rem] fixed top-[0rem] left-[50%] transform translate-x-[-50%] " id="Home">

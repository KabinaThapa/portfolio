    ...
    <div>
        ...
        onClick={handleNav} className='absolute top-4 right-4 z-[99] md:hidden ' />
        {
          nav ? (
            <div className= 'fixed w-full h-screen flex-col flex justify-center items-center md:mr-4'>
              <a href="/" className=" w-3/4 flex justify-center items-center  border rounded-xl ml-4  mr-4 mb-4 bg-slate-200 p-1 shadow-lg shadow-gray-300 cursor-pointer hover:scale-110 ease-in duration-200">
        ...
        <div className='md:block hidden bg-slate-400  '> 
          <div className='flex flex-col fixed top-1/4 z-30'>
            <a href="/" className='relative group border-1 flex justify-center  items-center rounded-full lg:p-4 md:p-2 m-2 bg-slate-100 shadow-md shadow-gray-700 cursor-pointer hover:scale-110 ease-in duration-200'> 
